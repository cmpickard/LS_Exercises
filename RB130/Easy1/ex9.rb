...
# truthy value for exactly one element, then #one? returns true. Otherwise, #one?
#  returns false. Note in particular that #one? will stop searching the collection
#   the second time the block returns true.
